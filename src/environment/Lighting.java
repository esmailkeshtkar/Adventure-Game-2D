...
public class Lighting {
	...
	public void draw(Graphics2D g2) {
		...
		switch(dayState) {
		case day: currentState = "day"; break;
		case dusk: currentState = "dusk"; break;
		case night: currentState = "night"; break;
		case dawn: currentState = "dawn"; break;
		}
		
		g2.setColor(Color.white);
		g2.setFont(g2.getFont().deriveFont(50f));
		g2.drawString(currentState, 800, 600);
	}
}
